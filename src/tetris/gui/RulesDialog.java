...
public class RulesDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Tetris é um jogo em que se empilha tetraminós para completar linhas\nhorizontais e ganhar pontos. \nOs blocos caem do topo e você \npodemovê-los e girá-los. O jogo\ntermina quando os blocos alcançam o topo da tela. O objetivo é marcar\no máximo de pontos possível.");
